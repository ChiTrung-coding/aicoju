...
namespace Modules\SpondonItLmsService\Http\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Modules\SpondonItLmsService\Repositories\InstallRepository;
use Modules\SpondonItService\Repositories\InstallRepository as ServiceRepository;
use Modules\SpondonItLmsService\Http\Requests\UserRequest;
