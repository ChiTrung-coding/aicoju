...
class CreatePermissionsTables extends Migration
{
    ...
    public function up()
    {
        ...
        $sql = [
            ...
            ['id' => 100, 'module_id' => 6, 'parent_id' => 6, 'name' => 'Referral Setting', 'route' => 'coupons.inviteSettings', 'type' => 2],
            ...
            ['id' => 113, 'module_id' => 7, 'parent_id' => 7, 'name' => 'Add Quiz', 'route' => 'online-quiz', 'type' => 2],
...
//            ['id' => 180, 'module_id' => 12, 'parent_id' => 179, 'name' => 'View', 'route' => 'EmailTemp', 'type' => 3],
            ...
            ['id' => 271, 'module_id' => 16, 'parent_id' => 16, 'name' => 'Subscriber', 'route' => 'newsletter.subscriber', 'type' => 2],
