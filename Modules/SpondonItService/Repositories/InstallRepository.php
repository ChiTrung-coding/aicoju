...
namespace Modules\SpondonItService\Repositories;
...
class InstallRepository
{
    ...
    public function validateLicense($params)
    {
        ...
        $response = [
            "status" => true,
            "checksum" => "eyJpdiI6Ikg2Z2dDaFBMVlNZN2dJcUovUFdZa2c9PSIsInZhbHVlIjoiSlZBU2ZCNUxqMEVFM3VQV2xtdHYybDl6RjNweGdLbDdhZDZnam1WTi9USlpYV204aTR1ZHRaUnBSaWxMYjVSVyIsIm1hYyI6IjBmOTA3M2ExYmU4NTkxZDBhMWM1MWQ4YWU5MjkxMjAzNDMxNmZiOGNmYzRhOWMzOTk1NmZiYWIzYTBhNDAyNjgiLCJ0YWciOiIifQ==",
            "modules" => [],
            "routes" => [],
            "license_code" => "eyJpdiI6ImdGa254dUJncnJjRnN3NWI2c2ZERmc9PSIsInZhbHVlIjoiOVBSWE5NTjlKS3dRYmQzNDFkTHRneVg4bndHRDNpK3J5VmZXMVcyc1ZTblZyWUFsdWVodFJ5Zk5Mc1VOUmJZYiIsIm1hYyI6ImM2NTIzNzI3ZWM2YmNjNGNhNWQ5YTE1NGNjOGUxZGQ3ZjI3MjMyZjlkNmYyMDhkMTU3ZWJjYTZkY2ZmMzM5ODgiLCJ0YWciOiIifQ==",
            "message" => "Congratulations! Your purchase code verified & configuration completed. Let's next step!"
        ];
