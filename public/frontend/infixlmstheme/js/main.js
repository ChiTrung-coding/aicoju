...
/*!**************************************************************!*\
  !*** ./node_modules/@firebase/app/dist/esm/index.esm2017.js ***!
  \**************************************************************/
/*! exports provided: FirebaseError, SDK_VERSION, _DEFAULT_ENTRY_NAME, _addComponent, _addOrOverwriteComponent, _apps, _clearComponents, _components, _getProvider, _isFirebaseApp, _isFirebaseServerApp, _registerComponent, _removeServiceInstance, _serverApps, deleteApp, getApp, getApps, initializeApp, initializeServerApp, onLog, registerVersion, setLogLevel */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_isFirebaseApp", function() { return _isFirebaseApp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_isFirebaseServerApp", function() { return _isFirebaseServerApp; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_serverApps", function() { return _serverApps; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initializeServerApp", function() { return initializeServerApp; });
...
function initializeApp(_options, rawConfig = {}) {
    ...
    options || (options = Object(_firebase_util__WEBPACK_IMPORTED_MODULE_2__["getDefaultAppConfig"])());
    if (!options) {
...
function initializeServerApp(_options, _serverAppConfig) {
    if (Object(_firebase_util__WEBPACK_IMPORTED_MODULE_2__["isBrowser"])() && !Object(_firebase_util__WEBPACK_IMPORTED_MODULE_2__["isWebWorker"])()) {
...
function getApp(name = DEFAULT_ENTRY_NAME) {
    ...
    if (!app && name === DEFAULT_ENTRY_NAME && Object(_firebase_util__WEBPACK_IMPORTED_MODULE_2__["getDefaultAppConfig"])()) {
...
function getDbPromise() {
    if (!dbPromise) {
        dbPromise = Object(idb__WEBPACK_IMPORTED_MODULE_3__["openDB"])(DB_NAME, DB_VERSION, {
...
class HeartbeatServiceImpl {
    ...
    async getHeartbeatsHeader() {
        ...
        try {
            ...
            const headerString = Object(_firebase_util__WEBPACK_IMPORTED_MODULE_2__["base64urlEncodeWithoutPadding"])(JSON.stringify({ version: 2, heartbeats: heartbeatsToSend }));
...
class HeartbeatStorageImpl {
    ...
    async runIndexedDBEnvironmentCheck() {
        if (!Object(_firebase_util__WEBPACK_IMPORTED_MODULE_2__["isIndexedDBAvailable"])()) {
            return false;
        }
        else {
            return Object(_firebase_util__WEBPACK_IMPORTED_MODULE_2__["validateIndexedDBOpenable"])()
                .then(() => true)
                .catch(() => false);
        }
    }
...
function countBytes(heartbeatsCache) {
    ...
    return Object(_firebase_util__WEBPACK_IMPORTED_MODULE_2__["base64urlEncodeWithoutPadding"])(
...
function getDbPromise() {
    if (!dbPromise) {
        dbPromise = Object(idb__WEBPACK_IMPORTED_MODULE_3__["openDB"])(DATABASE_NAME, DATABASE_VERSION, {
            upgrade: (db, oldVersion) => {
                // We don't use 'break' in this switch statement, the fall-through
                // behavior is what we want, because if there are multiple versions between
                // the old version and the current version, we want ALL the migrations
...
const publicFactory = (container) => {
    ...
    const heartbeatServiceProvider = Object(_firebase_app__WEBPACK_IMPORTED_MODULE_0__["_getProvider"])(app, 'heartbeat');
...
function registerInstallations() {
    Object(_firebase_app__WEBPACK_IMPORTED_MODULE_0__["_registerComponent"])(new _firebase_component__WEBPACK_IMPORTED_MODULE_1__["Component"](INSTALLATIONS_NAME, publicFactory, "PUBLIC" /* ComponentType.PUBLIC */));
    Object(_firebase_app__WEBPACK_IMPORTED_MODULE_0__["_registerComponent"])(new _firebase_component__WEBPACK_IMPORTED_MODULE_1__["Component"](INSTALLATIONS_NAME_INTERNAL, internalFactory, "PRIVATE" /* ComponentType.PRIVATE */));
}
...
async function migrateOldDatabase(senderId) {
    ...
    const db = await Object(idb__WEBPACK_IMPORTED_MODULE_2__["openDB"])(OLD_DB_NAME, OLD_DB_VERSION, {
...
function getDbPromise() {
    if (!dbPromise) {
        dbPromise = Object(idb__WEBPACK_IMPORTED_MODULE_2__["openDB"])(DATABASE_NAME, DATABASE_VERSION, {
...
function registerMessagingInWindow() {
    Object(_firebase_app__WEBPACK_IMPORTED_MODULE_4__["_registerComponent"])(new _firebase_component__WEBPACK_IMPORTED_MODULE_1__["Component"]('messaging', WindowMessagingFactory, "PUBLIC" /* ComponentType.PUBLIC */));
    Object(_firebase_app__WEBPACK_IMPORTED_MODULE_4__["_registerComponent"])(new _firebase_component__WEBPACK_IMPORTED_MODULE_1__["Component"]('messaging-internal', WindowMessagingInternalFactory, "PRIVATE" /* ComponentType.PRIVATE */));
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDefaultAppConfig", function() { return getDefaultAppConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDefaultEmulatorHost", function() { return getDefaultEmulatorHost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDefaultEmulatorHostnameAndPort", function() { return getDefaultEmulatorHostnameAndPort; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDefaults", function() { return getDefaults; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getExperimentalSetting", function() { return getExperimentalSetting; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isCloudflareWorker", function() { return isCloudflareWorker; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "promiseWithTimeout", function() { return promiseWithTimeout; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_isFirebaseApp", function() { return _firebase_app__WEBPACK_IMPORTED_MODULE_0__["_isFirebaseApp"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_isFirebaseServerApp", function() { return _firebase_app__WEBPACK_IMPORTED_MODULE_0__["_isFirebaseServerApp"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_serverApps", function() { return _firebase_app__WEBPACK_IMPORTED_MODULE_0__["_serverApps"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "initializeServerApp", function() { return _firebase_app__WEBPACK_IMPORTED_MODULE_0__["initializeServerApp"]; });
...
/***/ "./resources/js/frontend/main/init.js":
/*!********************************************!*\
  !*** ./resources/js/frontend/main/init.js ***!
  \********************************************/
/*! no exports provided */
  ...
  function initFCM() {
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker.register('/public/firebase-messaging-sw.js').then(function (registration) {
        ...
        var firebaseApp = Object(firebase_app__WEBPACK_IMPORTED_MODULE_0__["initializeApp"])(firebaseConfig); // Get registration token. Initially this makes a network call, once retrieved
        // subsequent calls to getToken will return from cache.

        var messaging = Object(firebase_messaging__WEBPACK_IMPORTED_MODULE_1__["getMessaging"])(firebaseApp);
        var vapidKey = $('.fcm_vapid_key').val();
  ...
  function handleFirebaseMessage(messaging) {
    Object(firebase_messaging__WEBPACK_IMPORTED_MODULE_1__["onMessage"])(messaging, function (payload) {
      ...
      try {
        ...
        var data = JSON.parse((_payload$data = payload.data) === null || _payload$data === void 0 ? void 0 : _payload$data.body);
        console.log(data);
        toastr.success(data.message, 'Success');

        if (data !== null && data !== void 0 && data["goto"]) {
          setTimeout(function () {
...
/***/ 0:
/*!**************************************************!*\
  !*** multi ./resources/js/frontend/main/init.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /www/wwwroot/newaicoju.edu.vn/resources/js/frontend/main/init.js */"./resources/js/frontend/main/init.js");
